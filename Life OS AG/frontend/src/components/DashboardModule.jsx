...
export function DashboardModule({ dashboardData, loading, setActiveTab, allLogs, onUpdate }) {
    ...
    return (
        <div className="space-y-12 pb-10">
            {/* Main Hero Card */}
            <div className="bg-[#f8fafc] rounded-[3rem] p-12 relative overflow-hidden border border-black/15 shadow-sm">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-5 gap-6">
                    {modules.map((mod) => (
                        <div
                            ...
                            className="rounded-[2.5rem] p-8 relative overflow-hidden group cursor-pointer hover:shadow-xl transition-all active:scale-95 shadow-sm border border-black/10"
            ...
            {/* All Logs Section */}
            <div className="bg-white rounded-[2.5rem] p-10 border border-black/10 shadow-sm">
